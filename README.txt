...
On a computer, the Browser button on the settings page opens the full visualizer in its own browser tab, served by Homey itself on your local network. There the map gets the whole screen, with a traffic overview of the busiest devices and panels you can fold away.
